...
namespace WebApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        [MiddlewareFilter(typeof(JsReportPipeline))]
        public IActionResult InvoiceDownloadGraphChart()
        {
            HttpContext.JsReportFeature().Recipe(Recipe.ChromePdf)
                .OnAfterRender((r) => HttpContext.Response.Headers["Content-Disposition"] = "attachment; filename=\"ReportGraph.pdf\"");

            return View("Chart");
        }

        [MiddlewareFilter(typeof(JsReportPipeline))]
        public IActionResult InvoiceDownloadNotRazor()
        {
            HttpContext.JsReportFeature().Recipe(Recipe.ChromePdf)
                .OnAfterRender((r) => HttpContext.Response.Headers["Content-Disposition"] = "attachment; filename=\"ReportGraph.pdf\"");
